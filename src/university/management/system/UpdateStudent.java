...
public class UpdateStudent extends JFrame implements ActionListener{
    ...
    JTextField tfdept,tfaddress, tfphone, tfemail;
    JLabel labelrollno;
    ...
    Choice crollno;
       ...
       UpdateStudent(){
        ...
        crollno = new Choice();
        crollno.setBounds(250, 85, 200, 30);
        add(crollno);
       ...
       public void actionPerformed(ActionEvent ae){
           if(ae.getSource()==submit){
              ...
              try{
                  String query = "Update student set address='"+address+"', phone= '"+phone+"',email= '"+email+"', dept='"+dept+"' where rollno='"+rollno+"'";
                  Conn con =new Conn();
