...
public class UpdateTeacher extends JFrame implements ActionListener{
    ...
    JTextField tfdept,tfaddress, tfphone, tfemail,tfqlc;
    JLabel labelempid;
   ...
   UpdateTeacher(){
        ...
        cempid = new Choice();
        cempid.setBounds(250, 85, 200, 30);
        add(cempid);
        ...
        try{
          ...
          JLabel labelxii= new JLabel();
           ...
           lblnid.setBounds(50, 350, 200, 30);
           lblnid.setFont(new Font("serif", Font.BOLD, 20));
           add(lblnid);
           
           JLabel labelnid= new JLabel();
           labelnid.setBounds(200, 350, 150, 30);
            labelnid.setFont(new Font("serif", Font.PLAIN, 20));
           add(labelnid);
           
               JLabel lblqlc = new JLabel("Qualification");
           lblqlc.setBounds(400, 400, 200, 30);
           lblqlc.setFont(new Font("serif", Font.BOLD, 20));
           add(lblqlc);
           
             tfqlc= new JTextField();
           tfqlc.setBounds(600,400,150,30);
           tfqlc.setBackground(Color.WHITE);
           add(tfqlc);
           ...
           tfdept.setBounds(200,400,150,30);
           ...
           try{
             ...
             while(rs.next()){
                ...
                tfqlc.setText(rs.getString("qlc"));
       ...
       public void actionPerformed(ActionEvent ae){
           if(ae.getSource()==submit){
              ...
              String qlc = tfqlc.getText();
              String dept = tfdept.getText();
              
              try{
                  String query = "Update teacher set address='"+address+"', phone= '"+phone+"',email= '"+email+"', qlc='"+qlc+"', department='"+dept+"' where empid='"+cempid.getSelectedItem()+"'";
                  Conn con =new Conn();
